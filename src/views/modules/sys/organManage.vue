        ...
        <div class="coat2">
          ...
          <div class="dialog">
              ...
              <div class="from">
                <el-form ref="form" :model="form" status-icon :rules="rules" :hide-required-asterisk = 'asterisk' label-width="50%" class="demo-ruleForm">
                  ...
                  <el-form-item label="上级机构" prop="superior">
                    <el-select v-model="form.superior" popper-class='fromselect' placeholder="请选择部门">
                      <el-option v-for="item in superiorList"
                                 :key="item.value"
                                 :label="item.label"
                  ...
                  <el-form-item label="下辖授权数" prop="authNum">
                    <el-input v-model="form.authNum" placeholder="为大于0的整数"></el-input>
                  </el-form-item>
                </el-form>
              </div>
              <div class="butCoat">
            ...
            <fly-dialog title="编辑机构" :show.sync="editDialog">
              <div class="from">
                <el-form ref="form" :model="organInfo" status-icon :rules="rules" :hide-required-asterisk = 'asterisk' label-width="50%" class="demo-ruleForm">
                  <el-form-item label="机构名称" prop="name">
                  ...
                  <el-form-item label="机构状态" prop="state">
                    <el-select v-model="organInfo.state" popper-class='fromselect' placeholder="请选择部门">
                  ...
                  <el-form-item label="下辖授权数" prop="authNum">
                    <el-input v-model="organInfo.authNum" placeholder="为大于0的整数"></el-input>
                  </el-form-item>
                </el-form>
              </div>
              <div class="butCoat">
