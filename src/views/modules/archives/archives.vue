      ...
      <div class="coat2">
        <div class="archivesCoat1">
          ...
          <div class="idInfo">
            ...
            <div><span>出生日期</span>&nbsp;<span>1969年03月11日</span></div>
            <div><span>联系电话</span>&nbsp;<span>13466464462</span></div>
            <div><span>现居地</span>&nbsp;<span>四川省成都市青羊区清江东路锦绣花苑5栋2单元1120室</span></div>
          </div>
        </div>
            ...
            <div class="listType">
              <div class="list">
                <el-menu
                  ...
                  @open="handleOpen"
                  @close="handleClose">
                  <label v-for="(item,index) in personArchives" :key="index">
                        ...
                        >
                          ...
                          <el-table-column
                            ...
                            <template slot-scope="scope">
                              <i @click="handleClick(item.name,item.tableCN, scope.row)" class="el-icon-circle-plus"></i>
                            </template>
                          </el-table-column>
                        </el-table>
                      </div>
                      ...
                      <div class="archives_table">
                        ...
                        >
                          ...
                          <el-table-column
                            ...
                            width="100">
                            <template slot-scope="scope">
                              <i @click="handleClick(scope.row)" class="el-icon-circle-plus"></i>
                            </template>
                          </el-table-column>
                        </el-table>
                      </div>
        ...
        <div class="dialog">
          ...
          <fly-dialog :title="dialogInfo.title" :show.sync="showDialog">
            <div class="dialogInfoCoat">
              <div class="dialogInfo" v-for="(item3,index3) in dialogInfo.showList.tableCN" :key="index3">
              <span>{{item3.label}}</span>
              <span>{{dialogInfo.showList.tableValue[item3.prop]}}</span>
            </div>
            </div>
            <div class="butCoat">
            <el-button class="canBut" @click="showDialog = false">取 消</el-button>
          </div>
          </fly-dialog>
        </div>
      </div>
