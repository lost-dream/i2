  ...
  <div class="container">
    <div class="bg">
      ...
      <div class="searchList">
        <el-table :data="converseData2" height="250" border style="width: 100%">
          ...
          <el-table-column prop="timeChange" align="center" label="通话时间">
            <template slot-scope="scope">
              <span>{{ scope.row.beginTime | formatDate }}</span>
            </template>
          </el-table-column>
          <el-table-column prop="datetime" align="center" label="通话时长">
          </el-table-column>
          <el-table-column prop="location" align="center" label="通信地点">
          </el-table-column>
          <el-table-column prop="baseLocation" align="center" label="基站地址">
          </el-table-column>
          <el-table-column
            prop="stationCode"
            align="center"
          ...
          <el-table-column prop="imsi" align="center" label="IMSI">
          </el-table-column>
        </el-table>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    callTimeSizer() {
      ...
      let dataArr = []
      data.forEach(item => {
        this.timeToSec(callTime) <= this.timeToSec(item.datetime) &&
          dataArr.push(item)
      })
