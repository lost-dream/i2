  ...
  <div class="container">
    ...
    <el-form :inline="true"
      ...
      <el-form-item label="呼叫时间"
                    prop="time">
        <el-date-picker v-model="assignForm.time"
                        type="datetimerange"
      ...
      <el-form-item prop="event">
        <el-select v-model="assignForm.event"
                   placeholder="选择分析项目">
      ...
      <el-form-item>
        <el-button type="danger"
                   @click="resetForm('assignForm')">重置</el-button>
      </el-form-item>
    </el-form>
    <el-table :data="assign"
              border
              style="width: 100%">
...
export default {
  ...
  data () {
    return {
      ...
      tableHead: [
        { propName: 'phoneNum', label: '13111111111', fixed: true, width: '200' },
        { propName: 'phoneNum', label: '15111111111', fixed: true, width: '200' }
      ]
    };
  },
  methods: {
