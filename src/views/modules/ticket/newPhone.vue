    ...
    <div class="bg">
      ...
      >
        ...
        <el-form-item>
          <el-button
            type="primary"
            @click="submitUpload;oper=='新建话单'? submitForm('ticketForm'):(oper=='编辑话单'?ticketAlter('ticketForm'):ticketAddTo('ticketForm'))"
          >保存
          </el-button>
          <el-button
            type="danger"
            @click="resetForm('ticketForm')"
          >重置
          </el-button>
        </el-form-item>
      </el-form>
